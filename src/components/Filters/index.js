...
function Filters({ example }) {
    ...
    function applyFilters() {
        setFilterStatus(
            (buyCheck && auctionCheck) || (!buyCheck && !auctionCheck) ? "all" : buyCheck ? "Buy now" : "In auction",
        );
                        ...
                        {popups[1] && (
                            <div>
                                <Radiobutton
                                    text={"All items"}
                                    group={"quantity"}
                                    onClick={() => setQuantityCheck("all")}
                                />
                                <Radiobutton
                                    text={"Single items"}
                                    group={"quantity"}
                                    onClick={() => setQuantityCheck("single")}
                                />
                                <Radiobutton
                                    text={"Bundles"}
                                    group={"quantity"}
                                    onClick={() => setQuantityCheck("bundles")}
                                />
                            </div>
                        )}
                    </div>
                    ...
                    {/* <div class="filters__rarity">
                        ...
                        {popups[3] && (
                            <>
                                <Checkbox
                                    text={"Common"}
                                    onClick={e => addOrRemoveRarityCheck(e.target.innerText.toLowerCase())}
                                />
                                <Checkbox
                                    text={"Epic"}
                                    onClick={e => addOrRemoveRarityCheck(e.target.innerText.toLowerCase())}
                ...
                {popups[4] && (
                    <>
                        ...
                        <Checkbox
                            ...
                            onClick={e => addOrRemoveEmotionalCheck(e.target.innerText)}
                        />
                        <Checkbox
                ...
                {popups[5] && (
                    <div>
                        {categories.map(category => (
                            <Checkbox
                                text={category}
                                onClick={e => addOrRemoveCategoryCheck(e.target.innerText.toLowerCase())}
                            />
                        ))}
                    </div>
                )}
