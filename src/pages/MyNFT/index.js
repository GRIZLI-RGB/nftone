...
function MyNFT() {
    ...
    useEffect(() => {
        if (acceptedFilesFromBanner.length > 0) {
            ...
            axios
                .post("https://nft-one.art/api/users/upsert", formData, {
                    headers: {
    ...
    return (
        <>
            ...
            <section
                ...
                <div className="myBanner--extra" style={{ opacity: `${bannerHover && bannerHash ? "1" : "0"}` }}>
                    +
                </div>
                <input
                    className="myBanner--mobileLoad"
                    {...getInputPropsFromBanner()}
                    type="file"
            ...
            <section className={`myContent ${changeTheme("", "myContent--dark")}`}>
                <div class="myContent__left">
                    ...
                    {window.innerWidth <= 768 ? (
                        filtersMobile && (
                            <Filters
                                example={windowView === "nft" || windowView === "favorite" ? "nft" : "collection"}
                            />
                        )
                    ) : windowView === "nft" ? <Filters example={"nft"}/> : windowView === "collection" ? <Filters example={"collection"}/> : <Filters example={"nft"}/>
                    }
                </div>
                            ...
                            <>
                                ...
                                {collections.length > 0 ? (
                                    collections
                                        ...
                                        .map(collection => (
                                            <CollectionCard collection={collection} currentUser={currentUser} />
                                        ))
                                ) : (
            ...
            {editProfile && (
                <div className={changeTheme("editProfile", "editProfile editProfile--dark")}>
                    <div
                        ...
                        style={{ background: changeTheme("#fff", "#1c2026"), color: changeTheme("", "#fff") }}>
                        <h1>Edit Profile</h1>
                        ...
                        <div className="editProfile__box-social">
                            ...
                            <ul>
                                <li>
                                    <input
                                        type="text"
                                        placeholder={socialLinks.vk ? socialLinks.vk : `account-id`}
                                        value={socialForm.vk}
                                        data-social="vk"
                                ...
                                <li>
                                    <input
                                        type="text"
                                        placeholder={socialLinks.telegram ? socialLinks.telegram : `nickname`}
                                ...
                                <li>
                                    <input
                                        type="text"
                                        placeholder={socialLinks.twitter ? socialLinks.twitter : `nickname`}
                                ...
                                <li>
                                    <input
                                        type="text"
                                        placeholder={socialLinks.reddit ? socialLinks.reddit : `nickname`}
                                ...
                                <li>
                                    <input
                                        type="text"
                                        placeholder={socialLinks.discord ? socialLinks.discord : `server-id`}
                            ...
                            <div>
                                <input
                                    ...
                                    placeholder={
                                        email !== ""
                                            ? email
                                            : currentUser.unconfirmed_email !== "" && currentUser?.unconfirmed_email
                        ...
                        <button className="editProfile__box-save" onClick={saveForm}>
                            Save
                        </button>
                        <img
